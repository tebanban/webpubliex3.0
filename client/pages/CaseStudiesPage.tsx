  ...
  return (
    <main>
      ...
      <section className="bg-publiex-navy px-5 py-20 text-white md:px-10 lg:px-24">
        <div className="mx-auto grid max-w-393.5 gap-5 md:grid-cols-3 xl:gap-10">
          {cases.map((item) => (
            <ImagePanel
              image={item.image}
              key={item.title}
            ...
            >
              ...
              <h2 className="font-raleway text-2xl font-semibold leading-tight md:text-[39.44px] md:leading-11">
                {item.title}
              </h2>
            </ImagePanel>
          ))}
