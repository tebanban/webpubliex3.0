...
export default function HomePage() {
  return (
    <main className="bg-white text-black">
      ...
      <section
        className="bg-publiex-gradient px-5 py-20 text-white md:px-10 lg:px-24 xl:min-h-[2140px] xl:pt-[71px]"
        id="soluciones"
      >
      ...
      <section
        className="grid min-h-[720px] bg-publiex-navy text-white lg:grid-cols-[52%_48%] xl:min-h-[1101px]"
        id="analitica"
      >
        <img
